...
if (
  typeof data?.tailored_summary !== "string" ||
  !Array.isArray(data?.tailored_experience) ||
  !Array.isArray(data?.tailored_projects) ||
  !Array.isArray(data?.recommended_existing_skills) ||
  !Array.isArray(data?.missing_skill_suggestions) ||
  !Array.isArray(data?.improvement_notes)
) {
  console.error(
    "Unexpected tailoring response:",
    data
  );
